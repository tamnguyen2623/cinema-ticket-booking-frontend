        ...
        <div className="flex min-h-screen items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style={{backgroundColor: "#DAD2B4"}}>
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-4 shadow-xl">
                ...
                <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button
                        type="submit"
                        className="w-full py-2 px-4 font-bold rounded-md hover:bg-blue-700 focus:outline-none"
                ...
                <button
                    onClick={resendOtp}
                    className="w-full py-2 px-4 font-bold rounded-md hover:bg-gray-600 focus:outline-none"
