...
import { Table, Spin, Alert, Button, Form, Input, DatePicker, Select, Modal, Upload, InputNumber } from 'antd';
...
const ComboPage = () => {
    ...
    const checkComboNameExist = async (name) => {
        const comboExists = combos.some((combo) => combo.name.toLowerCase() === name.toLowerCase());
        return comboExists;
    };
    const handleAddCombo = async () => {
        try {
            ...
            formData.append("image", {
                ...
                name: imageFile.name || `upload.${imageFile.type.split("/")[1] || "jpg"}`
            });
    ...
    const handleDeleteClick = (combo) => {
        Modal.confirm({
            ...
            content: `Are you sure you want to delete the combo "${combo.name}"?`,
            okText: "Confirm",
            cancelText: "Cancel",
            okType: "danger",
